...
# 28. Sink the Money Into the Part That Moves
...
![One hardware set, any size of house.](plate-hardware-set.png)
...
![What does not move when the house does.](plate-what-does-not-move.png)
...
![Build the chase on the bench.](plate-build-a-core.png)
...
![Close it, prove the cap, stand it up.](plate-core-cap.png)
...
![What a site can share, so the dome does not have to.](plate-shared-services.png)
...
![The core moves to the next dome.](plate-core-moves.png)
