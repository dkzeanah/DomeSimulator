...
const RENDER_DIR = path.join(RUN_DIR, "renders", "v003");
const OUTPUT_PPTX = path.join(
  RUN_DIR,
  "wheelchair_first_dome_living_20260816_082305_v003.pptx",
);
...
async function main() {
  ...
  // 6 — entry benchmarks.
  {
    ...
    repaintHeader(slide, "The entrance is the first independence test", 6);
    setNotes(
      slide,
