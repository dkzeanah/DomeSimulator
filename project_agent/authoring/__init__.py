...
Paste the result into a code-capable model. The manual authoring GUI offers
Compact and Full packets with size estimates. Check the model's configured
context, leaving room for its answer; parameter count alone is not a guide.
"""
