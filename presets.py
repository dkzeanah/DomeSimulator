...
PRESETS: list[tuple[str, dict]] = [
    ...
    ("Whole Trunk Lodge - 20 ft", {
        ...
        "layers": ["None", "None", "None"],
        "foundation": "Gravel Pad",
        "foundation_scale": 1.25,
        "partitions": "Low Walls",
        "sections": ["Lounge", "Kitchen", "Storage", "Unassigned",
                     "Storage", "Assembly", "Unassigned", "Office",
                     "Unassigned", "Unassigned"],
        "props": [
            {"type": "Worktable", "x": 0.0, "y": -2.8, "yaw": 0.0},
            {"type": "Shelving Unit", "x": -3.2, "y": -1.6, "yaw": 55.0},
            {"type": "Crate Stack", "x": 3.0, "y": -1.8, "yaw": 330.0},
            {"type": "Sofa", "x": -0.7, "y": 1.6, "yaw": 185.0},
            {"type": "Kitchenette", "x": 2.6, "y": 2.9, "yaw": 225.0},
            {"type": "Office Desk", "x": -3.4, "y": 2.6, "yaw": 140.0},
            {"type": "Office Chair", "x": -2.8, "y": 2.1, "yaw": 320.0},
            {"type": "Tripod Light", "x": 1.2, "y": -0.4, "yaw": 0.0},
            {"type": "Tripod Light", "x": -1.2, "y": 0.4, "yaw": 0.0},
        ],
    }),
    ("Grow Dome", {
